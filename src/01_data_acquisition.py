...
Reference:
    See Section 3 of the associated paper for the full data requirements.
    All steps in this stage are platform-agnostic and can be performed using
    any GIS software or scripting language.
...
def run(config):
    ...
    #   - floorspace_sqft : Usable floorspace (enables Version 2 of the framework)
